            ...
            <Carousel>
                <div>
                    ...
                    <div className="absolute left-[15%] top-[25%] ms-10 text-center  bg-transparent sm:left-[30px] sm:ms-0 sm:top-[10px] md:left-[5%] md:top-[10%] lg:left-[10%] lg:top-[20%]">
                        ...
                        <button onClick={()=>{navigate("/products")}} className="border border-orange-400 text-[#fb923c] px-4 py-2 mt-3 hover:bg-[#fb923c] hover:text-white sm:mt-0">Discover More</button>
                    </div>
                </div>
                <div>
                    ...
                    <div className="absolute left-[15%] top-[25%] ms-10 text-center bg-transparent sm:left-[30px] sm:ms-0 sm:top-[10px] md:left-[5%] md:top-[10%] lg:left-[10%] lg:top-[20%]">
                        ...
                        <button onClick={()=>{navigate("/products")}} className="border border-orange-400 text-[#fb923c] px-4 py-2 mt-3 hover:bg-[#fb923c] sm:mt-0 hover:text-white">Shop Now</button>
                    </div>
